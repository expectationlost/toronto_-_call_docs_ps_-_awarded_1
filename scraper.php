...
$status11 = $status[10];
$status11 = substr($status11,9);
print "\n" . "status11" . $status11 . "\n";

$status12 = $status[11];
$status12 = substr($status12,9);
print "\n" . "status12" . $status12 . "\n";
#print "\n" . "status2b" . $status2 . "\n";
...
$date10 = trim(str_replace("&nbsp;Date:","",$date10));
   ...
   $date11 = $date[10];
$date11 = strip_tags($date11);
$date11 = trim(str_replace("&nbsp;Date:","",$date11));


   $date12 = $date[11];
$date12 = strip_tags($date12);
$date12 = trim(str_replace("&nbsp;Date:","",$date12));
